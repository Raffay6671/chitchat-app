...
class _CreateGroupScreenState extends State<CreateGroupScreen> {
  ...
  List<Map<String, String>> allUsers = []; // 🔹 Store all fetched userss
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      border:
                          InputBorder.none, // ✅ No border to match original UI
                      hintText: "Group Name",
                      hintStyle: TextStyle(
                        fontFamily: 'Poppins',
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Poppins', // ✅ Correct Font Family
                      fontWeight:
                          FontWeight.w600, // ✅ Medium (500) (Closest to 550)
                      fontSize: 44, // ✅ Font Size 44px
                      height:
                          1.25, // ✅ Matches Line Height 50px (44 * 1.25 ≈ 55)
                      letterSpacing:
                          0.2, // ✅ Slightly Increase Spacing to Balance Weight
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      ...
                      style: TextStyle(
                        ...
                        color:
                            AppColors
                                .mutedGreyText, // ✅ Uses new color from AppColors
                      ),
                    ),
                  ),
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  if (_groupName.isEmpty) {
                    errorMessage =
                        "✏️ Please enter a group name before creating!";
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        "🎉 Group '$_groupName' created successfully!",
                      ),
                  ...
                  try {
                    ...
                    if (response.statusCode == 201) {
                      ...
                      socketService.joinGroup(newGroupId);

                      // ✅ Pop current screen and refresh UserContainer in MessageScreen
                      Navigator.pop(
                        context,
                        true,
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      AppColors
                          .buttonColor, // ✅ Button background matches Figma (#FFFFFF)
                ...
                child: const Text(
                  ...
                  style: TextStyle(
                    ...
                    color:
                        AppColors
                            .white, // ✅ Text color now matches correct Figma color
                  ),
                ),
              ),
            ),
    ...
    return Container(
      ...
      child: Text(
        ...
        style: const TextStyle(
          ...
          color: Color(
            0xFF000E08,
          ), // ✅ Text Color (Same as provided background)
        ),
      ),
    );
  }
      ...
      children:
          allUsers.map((user) {
            ...
            return GestureDetector(
              onTap:
                  () =>
                      _toggleUserSelection(userId), // ✅ Fix: Use central method
              child: Stack(
                children: [
                  _buildMemberAvatar(
                    userId,
  ...
  Widget _buildMemberAvatar(String userId, String? profilePicture) {
    bool isInvited = invitedUserIds.contains(
      userId,
