...
Future<void> _fetchAllUsers() async {
  try {
    List<Map<String, String>> fetchedUsers = await AuthService.fetchAllUsers(context);

    log("Fetched Users: $fetchedUsers", name: "UserFetch");
    log("Users Length: ${fetchedUsers.length}", name: "UserFetch");
      ...
      child: _isLoading
          ...
          : Column(
              ...
              children: [
                const TopNavBar(),
                const StatusBar(),
                Expanded(child: UserContainer(users: users)),
              ],
            ),
    );
  }
